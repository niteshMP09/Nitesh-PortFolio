        ...
        <div className="animate-[fadeInUp_1s_ease-out] order-2 md:order-1">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <a
              ...
              className="px-4 py-2 rounded-lg font-semibold bg-transparent text-slate-100 border-2 border-indigo-500 transition-all duration-300 hover:bg-indigo-500 hover:-translate-y-0.5 flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg font-semibold bg-transparent text-slate-100 border-2 border-indigo-500 transition-all duration-300 hover:bg-indigo-500 hover:-translate-y-0.5"
            >
              View Projects
            </button>
          </div>
